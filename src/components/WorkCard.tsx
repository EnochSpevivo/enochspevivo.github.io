...
const WorkCard = ({ logo, company, title, stack, blurb }: WorkCard) => {
    ...
    return (
        ...
        <div className="flex flex-col basis-[100%] p-[20px] bg-white/10 cursor-pointer gap-y-2 text-[15px] md:basis-[49.5%] lg:p-[30px] text-[16px] xl:basis-[33%]">
